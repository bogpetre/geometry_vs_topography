...
subjectlevel.connect([
    ...
    (stddistwf, datasink, [('outputspec.rdm', 'results.standardized_betas.@stddist'),
                       ...
                       ('outputspec.betas_l1', 'results.sess_standardized_betas.@merged_cifti_stdbetas'),
    ...
    (crossnobiswf, datasink, [('outputspec.rdm', 'results.whitened_betas.@stddist'),
                       ...
                       ('outputspec.betas_l1', 'results.sess_whitened_betas.@merged_cifti_whitenedbetas'),
...
if __name__ == '__main__':
    ...
    parser.add_argument('--nonstandard_template', required=False, action='store_true', default=False,
