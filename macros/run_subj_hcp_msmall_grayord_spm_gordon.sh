#!/bin/bash
#SBATCH --job-name 7SPM_GLMs_gordon
...
#SBATCH --output hcp_glm_msmall_grayord_spm_gordon.logs/firstlvl_bsc_%a.out
#SBATCH --account dbic
#SBATCH --array 1-208
#SBATCH --exclude=
...
# This script runs first level GLMs, RSA and computes topographic similarities using the
# Gordon parcellation. This is a santiy check that our results are robust w.r.t. parcellation 
# scheme.
...
ATLAS=$(readlink -f ../resources/Gordon_333Cort.32k.dlabel.nii)
